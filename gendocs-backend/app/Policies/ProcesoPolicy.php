...
class ProcesoPolicy
{
    ...
    {
        return $user->getAllPermissions()->contains('name', Permissions::Procesos['index']);
    }
    ...
    {
        return $user->getAllPermissions()->contains('name', Permissions::Procesos['create']);
    }
    ...
    {
        return $user->getAllPermissions()->contains('name', Permissions::Procesos['update']);
    }
