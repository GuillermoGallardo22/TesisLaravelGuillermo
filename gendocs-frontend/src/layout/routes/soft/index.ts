...
export const routes: IRoute[] = [
  ...
  {
    path: "documentos-soft",
    label: "Documentos",
    component: DocumentosSOFTOUTLET,
    icon: "topic",
    modules: [ModuleEnum.SOFT],
    isMenuOption: true,
    childrens: [
  ...
  },
  {
    ...
    childrens: [
      ...
      { path: "", isIndex: true, component: ProcesosSOFT },
    ],
  },
  {
    path: "consejos-soft",
    label: "Consejos",
    component: ConsejosSOFTOUTLET,
    icon: "meetingRoom",
    modules: [ModuleEnum.SOFT],
    childrens: [
      {
