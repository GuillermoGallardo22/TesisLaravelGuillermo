...
import { generarReporteActaGradoInicial } from "services/actas-grado";
...
const ActaGradoReporte = () => {
  ...
  const onSubmit = async (
    ...
    const { data } = await generarReporteActaGradoInicial({
      queryParams: {
  ...
  return (
    <Stack spacing={2}>
      <TitleNav title="Reporte actas de grado Inicial" />
